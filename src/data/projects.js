...
{title: 'WERK',
description: "WERK is a fun web application designed for job seekers in the tech world. This app offers a variety of features to help job seekers stay organized in one space. This is a full-stack MERN application that uses ReactJS, Node.js, Express, MongoDB, and CSS.",
image: 'WERK.png',
repositoryLink: 'https://github.com/ljchu87/werk-front-end.git',
deploymentLink: 'https://werk-smarter.netlify.app/'
},
{title: 'Finch Collector',
description: "This cool application is used to record or collect the birds that you see. This app was built with Python, HTML, CSS, and Django.",
image: 'finchCollector.png',
repositoryLink: 'https://github.com/laurenhatchett/finch-collector.git',
deploymentLink: 'https://laurenfinchcollector.herokuapp.com/'
}
]
